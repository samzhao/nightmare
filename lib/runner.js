...
app.on('ready', function() {
  ...
  parent.respondTo('browser-initialize', function(opts, done) {
    // for turning off web-security, use 'webSecurity' without the dash
    // it is best to have both 'web-security' and 'webSecurity' in your config
    var webPreferences = defaults(opts['web-preferences'] || {}, {
